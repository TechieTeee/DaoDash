...
import {
  AiFillBank, AiFillBell,
  AiFillCamera,
  AiOutlineCamera,
  AiOutlineDashboard, AiOutlineDatabase,
  AiOutlineUser, AiTwotoneDatabase,
} from "react-icons/ai";
import { BsGithub } from "react-icons/bs";

const links = [
  { name: "Dashboard", to: "/dashboard", id: 2, icon: <AiFillBell /> },
  {
    name: "Membership Directory",
    to: "/membershipdirectory",
    id: 3,
    icon: <AiOutlineUser  />,
  },

  { name: "Payments + Gov", to: "/gov&payments", id: 5, icon: <AiFillBank /> },
];
        ...
        >
          <div className="relative flex flex-col justify-between h-[calc(100vh_-_80px)]">
            ...
            <motion.div className="py-8 flex flex-col">
              <a
                  href="https://github.com/TechieTeee/DaoDash"
                  target="_blank"
